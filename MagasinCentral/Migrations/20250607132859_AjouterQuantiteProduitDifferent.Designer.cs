...
namespace MagasinCentral.Migrations
{
    ...
    [Migration("20250607132859_AjouterQuantiteProduitDifferent")]
    partial class AjouterQuantiteProduitDifferent
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MagasinCentral.Models.Vente", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            VenteId = 1,
                            Date = new DateTime(2025, 6, 5, 13, 28, 58, 82, DateTimeKind.Utc).AddTicks(1431),
                            MagasinId = 1,
                            PrixUnitaire = 1.50m,
                            ProduitId = 1,
                            Quantite = 10
                        ...
                        {
                            VenteId = 2,
                            Date = new DateTime(2025, 6, 6, 13, 28, 58, 82, DateTimeKind.Utc).AddTicks(1440),
                            MagasinId = 2,
                            PrixUnitaire = 12.00m,
                            ProduitId = 3,
                            Quantite = 5
                        ...
                        {
                            VenteId = 3,
                            Date = new DateTime(2025, 6, 6, 13, 28, 58, 82, DateTimeKind.Utc).AddTicks(1442),
                            MagasinId = 1,
                            PrixUnitaire = 3.75m,
                            ProduitId = 2,
                            Quantite = 7
                        ...
                        {
                            VenteId = 4,
                            Date = new DateTime(2025, 6, 7, 13, 28, 58, 82, DateTimeKind.Utc).AddTicks(1443),
                            MagasinId = 3,
                            PrixUnitaire = 45.00m,
                            ProduitId = 4,
                            Quantite = 2
